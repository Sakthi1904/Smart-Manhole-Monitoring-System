# 1 "smart_manhole_monitoring_system.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "smart_manhole_monitoring_system.c" 2
...
# 2 "smart_manhole_monitoring_system.c" 2
...
# 3 "smart_manhole_monitoring_system.c" 2
...
# 29 "smart_manhole_monitoring_system.c"
...
void main(void)
{
    ...
    while (1)
    {
        ...
        lcd_string("                ", 16);
        lcd_command(0x80);
        lcd_string(waterLevel, 16);


        lcd_command(0xC0);
        lcd_string("                ", 16);
        lcd_command(0xC0);
        lcd_string(tiltStatus, 16);


        char uartBuffer[64];
        sprintf(uartBuffer, "Tilt: %s , Distance: %d, %s\n", tiltStr, distance, waterLevel);
        UART_Write_Text(uartBuffer);
